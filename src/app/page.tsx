...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen">
      <nav className="fixed top-0 w-full bg-surface-elevated/90 backdrop-blur-md border-b border-stone-200/80 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* <div className="flex flex-1 items-center justify-center md:absolute md:left-1/2 md:-translate-x-1/2">
              <Link
                href="/explore"
                className="text-sm text-stone-700 hover:text-primary-600 transition-colors font-semibold px-4 py-2 rounded-full hover:bg-primary-50"
              >
                {t("landing", "explore")}
              </Link>
            </div> */}
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              <button
                ...
                className="text-sm font-medium text-stone-700 hover:text-primary-600 transition-colors px-2 sm:px-3 py-2 border border-stone-200 rounded-lg flex items-center gap-1.5"
                type="button"
              >
              ...
              {isAuthenticated ? (
                ...
                <>
                  <Link
                    href="/login"
                    className="hidden sm:inline text-sm font-medium text-stone-700 hover:text-primary-600 transition-colors px-3 py-2"
                  >
                    {t("landing", "signIn")}
                  </Link>
                  <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="/register"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border border-stone-300 hover:border-primary-300 text-stone-700 font-medium px-8 py-3.5 rounded-xl transition-colors text-base"
              >
                {t("landing", "getStarted")}
              </Link>
              <Link
                href="/login"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 text-stone-700 hover:text-primary-700 font-medium px-4 py-3.5 transition-colors text-base"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat) => (
              <div key={stat.labelKey} className="text-center">
                ...
                <div className="text-sm text-stone-500">{t("landing", stat.labelKey)}</div>
              </div>
            ))}
          </div>
        </div>
